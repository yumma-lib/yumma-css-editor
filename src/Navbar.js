    ...
    return (
        <div>
            ...
            <main className="nav-white">
                <p className="fw-500">Try Yumma CSS</p>
                <ul className="d-f">
                    ...
                    <li className="ml-1 t-black h:t-magenta"><a target="_blank" rel="noreferrer" href="https://github.com/yumma-lib/yumma-css-editor#readme">About</a></li>
                </ul>
            </main>
        </div>
    );
